              ...
              <div className="mb-4 sm:mb-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h2 className="text-lg sm:text-2xl font-bold text-gray-900">
                    Tous les services
                    <span className="ml-2 sm:ml-3 text-xs sm:text-sm font-normal text-gray-600">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 sm:px-4 py-2 rounded-xl font-medium hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg text-xs sm:text-sm"
                    >
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 sm:px-4 py-2 rounded-xl font-medium hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg text-xs sm:text-sm"
                    >
                      <Plus className="w-3 sm:w-4 h-3 sm:h-4 inline mr-1 sm:mr-2" />
                ...
                <div className="mb-3 sm:mb-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm sm:text-base"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-2 mb-4 sm:mb-6 overflow-x-auto pb-2">
                  <button
                    ...
                    className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl font-medium whitespace-nowrap transition-all text-xs sm:text-sm ${
