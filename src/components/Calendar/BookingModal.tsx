  ...
  return (
    <>
      ...
      <div className="hidden sm:block fixed inset-0 bg-black/60 backdrop-blur-sm z-50 animate-fadeIn">
        <div className="flex items-center justify-center min-h-screen p-4">
          <div className="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl transform animate-slideUp">
            <div className="sticky top-0 z-10 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 px-6 py-4 flex items-center justify-between rounded-t-3xl">
      ...
      <div className="sm:hidden">
        ...
        {/* Modal content - AVEC PADDING BOTTOM POUR LES BOUTONS */}
        <div 
          className="fixed left-0 right-0 bg-white z-45 overflow-y-auto"
          style={{ 
            top: mobileModalTop,
            bottom: 0,
            ...
            paddingBottom: '88px' // Espace pour les boutons fixes
          }}
        >
          {/* Header */}
          <div 
            className="sticky top-0 z-10 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 px-4 py-4 flex items-center justify-between"
            style={{
              borderTopLeftRadius: '24px',
              borderTopRightRadius: '24px'
            }}
        ...
        {/* Footer FIXE EN BAS - DANS LE MODAL CONTAINER */}
        <div 
          className="fixed left-0 right-0 bg-white border-t border-gray-200 p-4 flex gap-3 z-50"
          style={{
            bottom: 0,
