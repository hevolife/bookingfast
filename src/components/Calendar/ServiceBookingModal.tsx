      ...
      <>
        ...
        <div className="hidden sm:block fixed inset-0 bg-black/60 backdrop-blur-sm z-50 animate-fadeIn">
          <div className="flex items-center justify-center min-h-screen p-4">
            {/* 🔥 STRUCTURE CORRIGÉE : flex flex-col h-full max-h-[90vh] */}
            <div className="bg-white w-full sm:max-w-3xl flex flex-col h-full max-h-[90vh] sm:rounded-3xl shadow-2xl transform animate-slideUp">
              {/* Header - OUTSIDE scroll, flex-shrink-0, sticky top-0 */}
              <div className="flex-shrink-0 sticky top-0 z-10 relative overflow-hidden sm:rounded-t-3xl">
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-2xl p-4 border-2 border-gray-200">
                      ...
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border-2 ${getStatusColor(selectedBookingDetails.booking_status)}`}>
                        {getStatusLabel(selectedBookingDetails.booking_status)}
                      </span>
                    </div>
                    <div className="bg-gray-50 rounded-2xl p-4 border-2 border-gray-200">
                      <p className="text-sm text-gray-600 mb-2">Statut paiement</p>
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border-2 ${getPaymentStatusColor(selectedBookingDetails)}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{selectedBookingDetails.client_firstname} {selectedBookingDetails.client_name}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{selectedBookingDetails.client_email}</p>
                        </div>
                      </div>
                      {selectedBookingDetails.client_phone && (
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-900">{selectedBookingDetails.client_phone}</p>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{formatTime(selectedBookingDetails.time)}</p>
                        </div>
                      </div>
                      {selectedBookingDetails.service_name && (
                        <div className="flex items-center gap-3 md:col-span-2">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-900">{selectedBookingDetails.service_name}</p>
                          </div>
                        </div>
                      )}
                      {selectedBookingDetails.location && (
                        <div className="flex items-center gap-3 md:col-span-2">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-900">{selectedBookingDetails.location}</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 border-2 border-yellow-200">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center pb-3 border-b border-yellow-200">
                        ...
                        <span className="text-xl font-bold text-gray-900">{selectedBookingDetails.total_amount.toFixed(2)}€</span>
                      </div>
                      <div className="flex justify-between items-center pb-3 border-b border-yellow-200">
                        <span className="text-gray-700 font-medium">Montant payé</span>
                        <span className="text-xl font-bold text-green-600">{(selectedBookingDetails.payment_amount || 0).toFixed(2)}€</span>
                      </div>
                  ...
                  {selectedBookingDetails.notes && (
                    <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200">
                      ...
                      <p className="text-gray-700 whitespace-pre-wrap">{selectedBookingDetails.notes}</p>
                    </div>
                  )}
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-xl p-3 border-2 border-gray-200">
                    ...
                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border-2 ${getStatusColor(selectedBookingDetails.booking_status)}`}>
                      {getStatusLabel(selectedBookingDetails.booking_status)}
                    </span>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-3 border-2 border-gray-200">
                    <p className="text-xs text-gray-600 mb-1">Statut paiement</p>
                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border-2 ${getPaymentStatusColor(selectedBookingDetails)}`}>
                      {getPaymentStatusText(selectedBookingDetails)}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-sm text-gray-900">{selectedBookingDetails.client_firstname} {selectedBookingDetails.client_name}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-sm text-gray-900">{selectedBookingDetails.client_email}</p>
                      </div>
                    </div>
                    {selectedBookingDetails.client_phone && (
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-sm text-gray-900">{selectedBookingDetails.client_phone}</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-sm text-gray-900">{formatTime(selectedBookingDetails.time)}</p>
                      </div>
                    </div>
                    {selectedBookingDetails.service_name && (
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-sm text-gray-900">{selectedBookingDetails.service_name}</p>
                        </div>
                      </div>
                    )}
                    {selectedBookingDetails.location && (
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-sm text-gray-900">{selectedBookingDetails.location}</p>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-4 border-2 border-yellow-200">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center pb-2 border-b border-yellow-200">
                      ...
                      <span className="text-lg font-bold text-gray-900">{selectedBookingDetails.total_amount.toFixed(2)}€</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-yellow-200">
                      <span className="text-sm text-gray-700 font-medium">Montant payé</span>
                      <span className="text-lg font-bold text-green-600">{(selectedBookingDetails.payment_amount || 0).toFixed(2)}€</span>
                    </div>
                    <div className="flex justify-between items-center pt-2">
                ...
                {selectedBookingDetails.notes && (
                  <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                    ...
                    <p className="text-sm text-gray-700 whitespace-pre-wrap">{selectedBookingDetails.notes}</p>
                  </div>
                )}
  ...
  return (
    <>
      ...
      <div className="hidden sm:block fixed inset-0 bg-black/60 backdrop-blur-sm z-50 animate-fadeIn">
        <div className="flex items-center justify-center min-h-screen p-4">
          {/* 🔥 STRUCTURE CORRIGÉE : flex flex-col h-full max-h-[90vh] */}
          <div className="bg-white w-full sm:max-w-4xl flex flex-col h-full max-h-[90vh] sm:rounded-3xl shadow-2xl transform animate-slideUp">
            {/* Header - OUTSIDE scroll, flex-shrink-0, sticky top-0 */}
            <div className="flex-shrink-0 sticky top-0 z-10 relative overflow-hidden sm:rounded-t-3xl">
